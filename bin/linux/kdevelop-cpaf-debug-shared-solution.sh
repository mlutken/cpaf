...
BUILD_DIR="build_cbs/kdev_debug_shared"
cd ../..
mkdir -p $BUILD_DIR
cd $BUILD_DIR
CBS_ROOT_DIR=$CBS_ROOT_DIR CPAF_ROOT_DIR=$CPAF_ROOT_DIR cmake -D CMAKE_BUILD_TYPE:STRING=Debug -D CBS_BUILD=ON -D CBS_LIB_TYPE_TO_BUILD:STRING=SHARED -G "KDevelop3" ../..
popd
