...
public:
    ...
    size_t                      streams_count			(media_type_t mt) const   { return format_context_.streams_count(mt);}
    bool                        has_media_type			(media_type_t mt) const   { return streams_count(mt) > 0;}
    ...
    size_t                      first_stream_index		(media_type_t mt) const { return format_context_.first_stream_index(mt); }
