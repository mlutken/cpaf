...
//    std::chrono::microseconds   test_current_time_pos       () const;
...
//    std::chrono::milliseconds   test_current_time_pos_ms    () const { return std::chrono::duration_cast<std::chrono::milliseconds>(test_current_time_pos()); }
...
//    void                        test_adjust_time            (const std::chrono::microseconds& current_video_offset);
...
private:
    ...
    std::chrono::microseconds   reset_offset_;
    std::chrono::microseconds   paused_time_pos_;
    std::chrono::microseconds   video_offset_;
//    std::chrono::microseconds   test_reset_offset_;
