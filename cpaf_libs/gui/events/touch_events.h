...
struct touch : public base
{
    ...
    touch::type             tp              = type::unknown;//!< The type of the touch event: down, up, move
    ...
    std::int64_t            finger          = 0;            //!< Index of the finger in case of multi-touch events
    events::pointer_type    event_src_type  = pointer_type::touch;   //!< Event generated by a mouse or a touch device
};
