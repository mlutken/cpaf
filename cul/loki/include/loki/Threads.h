...
namespace Loki
{
    ...
    public:
        ...
        static IntType AtomicAdd(IntType& lval, IntType val)
        { return lval += val; }
        
        static IntType AtomicSubtract(IntType& lval, IntType val)
        { return lval -= val; }

        static IntType AtomicMultiply(IntType& lval, IntType val)
        { return lval *= val; }
        
        static IntType AtomicDivide(IntType& lval, IntType val)
        { return lval /= val; }
